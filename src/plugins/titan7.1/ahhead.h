...
struct    record_info    {
        ...
        short        ftype;    /* data type in file before reading (extension to original AH) */
...
#define TENSOR    4
#define DOUBLE    6
#define SHORT     0    /*Extensions from original Lamont*/
#define USGS      7    /*ahhead.h include file*/
#define INT       8    /* 32 bit, extension */
#define INTZ      9    /* 28 bit compressed, extension */
