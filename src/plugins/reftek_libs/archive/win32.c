#pragma ident "$Id: win32.c,v 1.1.1.1 2005/07/26 19:28:53 andres Exp $"
/* --------------------------------------------------------------------
 Program  : Any
...
H_FILE FileOpenForWrite(CHAR * filespec)
{
    ...
    handle = CreateFile(filespec,
        GENERIC_READ | GENERIC_WRITE,
        FILE_SHARE_READ,                    /* Allow others to read only */
        NULL,
