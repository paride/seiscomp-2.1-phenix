#pragma ident "$Id: evnfiles.c,v 1.1.1.1 2005/07/26 19:28:53 andres Exp $"
/* --------------------------------------------------------------------
 Program  : Any
...
CHAR *MakeEventFileSpec(STREAM * stream)
{
    ...
    */
    ...
    sprintf(stream->event.filespec, "%04ld%03ld%c%04X%c%01u%c%02ld%02ld%05lu_%08lx",
        year, doy, PATH_DELIMITER,
        stream->unit, PATH_DELIMITER,
        stream->stream, PATH_DELIMITER,
