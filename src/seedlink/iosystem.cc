...
class Connection
  ...
  public:
    Connection(unsigned int ipaddr_init, const string &host, int port,
      ...
      monitor(monitor_init), stations(stations_init), cmdwp(0)
      {
...
class ConnectionManagerImpl: public ConnectionManager
  ...
  public:
    ConnectionManagerImpl(const string &daemon_name_init, 
      ...
      int trusted_info_level_init, int untrusted_info_level_init,
      bool trusted_window_extraction_init,
...
ConnectionManagerImpl::ConnectionManagerImpl(const string &daemon_name_init, 
  ...
  rc_ptr<MasterMonitor> monitor_init, bool rlog_init, int max_conn_init,
  int trusted_info_level_init, int untrusted_info_level_init,
  bool trusted_window_extraction_init, bool untrusted_window_extraction_init,
  ...
  max_conn(max_conn_init), trusted_info_level(trusted_info_level_init),
  ...
  listenfd(-1), nconn(0), monitor(monitor_init)
  {
...
rc_ptr<ConnectionManager> make_conn_manager(const string &daemon_name, 
  ...
  int trusted_info_level, int untrusted_info_level,
  ...
  int max_bps, int to_sec, int to_usec)
  {
    return new ConnectionManagerImpl(daemon_name, software_ident,
      default_network_id, monitor, rlog, max_conn, trusted_info_level,
      untrusted_info_level, trusted_window_extraction,
