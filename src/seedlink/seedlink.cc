...
#ifndef SEEDLINK_DIR
#define SEEDLINK_DIR "/home/sysop/config/seedlink"
#endif
...
class Station
  ...
  public:
    ...
    Station(const string &name_init, rc_ptr<BufferStore> bufs_init,
      ...
      int proc_gap_warn_init, int proc_gap_flush_init):
    ...
    if(connectionManager == NULL)
      {
        ...
        connectionManager = make_conn_manager(daemon_name, ident_str,
          ...
          untrusted_window_extraction, bytespersec, 0, 100000);
      }
